...
import { Component, EventEmitter, input, output, Input, OnInit, Output, inject, signal, effect } from '@angular/core';
...
export class AppForm implements OnInit{
  ...
  public buttonLabel = input<string>('Submit');
  public formMessage = input<string>('');
  public formLink = input<string>('');
  public formLinkText = input<string>('');
  formValidator = input<ValidatorFn>();

  public submitForm = output<EventEmitter<User>>();
